            ...
            <form onSubmit={handleSendEmailReport} className="space-y-4">
              ...
              <div className="p-3 bg-surface-800/80 rounded-lg border border-surface-700 text-xs text-surface-400 space-y-2">
                ...
                <div className="space-y-1.5 text-surface-300">
                  <p>⚠️ <b>Low Inventory & Backorder Alert</b> — immediate when an order needs more stock.</p>
                  <p>📦 <b>Inventory Received Alert</b> — immediate after a restock.</p>
                  <p>📊 <b>Nightly Operations PDF Report</b> — scheduled daily.</p>
                  <p>⏱️ <b>SLA Delay/Escalation Alert</b> — immediate at 45/60/75/90 minutes.</p>
                  <p className="text-brand-500">Manage these switches and the report time from Data Management → Email Automation.</p>
                </div>
              </div>
